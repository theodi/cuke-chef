@redis-01 @redis
Feature: Install and configure Redis

  In order to have a queuing system
  As a DevOps person
  I want to have Redis installed and configured
  ...
  Background:
    ...
    * the "redis::install_from_package" recipe has been added to the "redis-01" run list
